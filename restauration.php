...
<head>
    ...
    <title>Activité - Restauration</title>
</head>
    ...
    <main>
        <div class="container">
            <div class="col l12 s12 m12">
                <h2 class="header">Restauration</h2>
            </div>
            <div class="container-fluid">
                <div class="row">
                    <div class="bgrestau banniere_activite col l12 m12 s12"></div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div>
                    <a href="contact.php?id=Restauration" class="col l4 offset-l4 s12 button_contact">
