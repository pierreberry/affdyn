...
<head>
    ...
    <title>Activité - Corporate</title>
</head>
    ...
    <main>
        <div class="container">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="bgcorporate banniere_activite col l12 m12 s12"></div>
                </div>
                <div class="mescards row">
                    <div class="col l3">
                        <div class="transparent card hoverable">
                            ...
                            <div class="macarte content-activity card-content">
                                <h5>Guidez</h5>
                                <p>Orientez vos clients et visiteurs vers vos différents services. Utilisez une borne tactile en dehors de la présence d'un agent d'accueil.</p>
                                <?php
                    ...
                    <div class="col l3">
                        <div class="transparent card hoverable">
                            ...
                            <div class="macarte content-activity card-content">
                                <h5>Informez</h5>
                                <p>Souhaitez une bienvenue personnalisée. Humanisez l'attente avec des messages dynamiques et mise à jour simplement.</p>
                                <?php
                                if (strpos($_SERVER['HTTP_USER_AGENT'], 'Edg') !== FALSE) {
                                ?>
        ...
        <div class="container">
            <div class="row">
                <div>
                    <a href="contact.php?id=Corporate" class="col l4 offset-l4 s12 button_contact">
