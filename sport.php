    ...
    <main>
        <div class="container">
            <div class="col l12 s12 m12">
                <h2 class="header">Sport</h2>
            </div>
            <div class="container-fluid">
                <div class="row">
                    <div class="bgsport banniere_activite col l12 m12 s12"></div>
                </div>
                <div class="mescards row">
                    <div class="col l3">
                        <div class="transparent card hoverable">
                            ...
                            <div class="macarte content-activity card-content">
                                <h5>Informez</h5>
                                <p>Captez l’attention de visiteurs en informant de vos actualités : des activités, des services, des prévisions météorologiques, …</p>
                                <?php
                    ...
                    <div class="col l3">
                        <div class="transparent card hoverable">
                            ...
                            <div class="macarte content-activity card-content">
                                <h5>Communiquez</h5>
                                <p>Améliorez l’expérience de vos clients : diffusez des informations pendant les attentes, présentez vos futurs évènements, vos tarifs, etc.</p>
                                <?php
                                if (strpos($_SERVER['HTTP_USER_AGENT'], 'Edg') !== FALSE) {
                                ?>
                                    <a class="btn-floating btn-small waves-effect waves-light red tooltipped hoverable" data-position="right" data-tooltip="Scoring" href="doc\Scoring.pdf" target="_blank"><i class="material-icons">picture_as_pdf</i></a>
                                <?php
                                } else {
                                ?>
                                    <a class="btn-floating btn-small waves-effect waves-light red tooltipped hoverable modal-trigger" data-position="right" data-tooltip="Scoring" href="#modal_scoring" target="_blank"><i class="material-icons">picture_as_pdf</i></a>
                                <?php
                                }
                                ?>
                            </div>
        ...
        <div class="container">
            <div class="row">
                <div>
                    <a href="contact.php?id=Sport" class="col l4 offset-l4 s12 button_contact">
