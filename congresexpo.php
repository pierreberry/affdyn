...
<head>
    ...
    <title>Activité - Congrès | Exposition</title>
</head>
    ...
    <main>
        <div class="container">
            <div class="col l12 s12 m12">
                <h2 class="header">Congrès | Exposition</h2>
            </div>
            <div class="container-fluid">
                <div class="row">
                    <div class="bgcongres banniere_activite col l12 m12 s12"></div>
                </div>
                <div class="mescards row">
                    <div class="col l3">
                        <div class="transparent card hoverable">
                            ...
                            <div class="macarte content-activity card-content">
                                <h5>Guidez</h5>
                                <p>Orientez vos visiteurs vers vos différentes expositions et manifestations.</p>
                                <?php
                    ...
                    <div class="col l3">
                        <div class="transparent card hoverable">
                            ...
                            <div class="macarte content-activity card-content">
                                <h5>Informez</h5>
                                <p>Offres promotionnelles, Informations locales, Circulation, Météo, … Intervenez instantanément sur la diffusion. </p>
                                <?php
                                if (strpos($_SERVER['HTTP_USER_AGENT'], 'Edg') !== FALSE) {
                                ?>
                    ...
                    <div class="col l3">
                        <div class="transparent card hoverable">
                            ...
                            <div class="macarte content-activity card-content">
                                <h5>Optimisez</h5>
                                <p>Diffusez la publicité de vos partenaires et générez du revenu.</p>
                                <?php
                                if (strpos($_SERVER['HTTP_USER_AGENT'], 'Edg') !== FALSE) {
                                ?>
        ...
        <div class="container">
            <div class="row">
                <div>
                    <a href="contact.php?id=Congrès%20|%20Exposition" class="col l4 offset-l4 s12 button_contact">
