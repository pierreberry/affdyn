...
<head>
    ...
    <title>Activité - Banque | Assurance</title>
</head>
    ...
    <main>
        <div class="container">
            <div class="col l12 s12 m12">
                <h2 class="header">Banque | Assurance</h2>
            </div>
            <div class="container-fluid">
                <div class="row">
                    <div class="bgbanque banniere_activite col l12 m12 s12"></div>
                </div>
                <div class="mescards row">
                    <div class="col l3">
                        <div class="transparent card hoverable">
                            ...
                            <div class="macarte content-activity card-content">
                                <h5>Guidez</h5>
                                <p>Orientez vos clients et visiteurs vers vos différents services. Informez vos conseillers de l'arrivé de leur rendez-vous par une borne tactile d'accueil.</p>
                                <?php
                    ...
                    <div class="col l3">
                        <div class="transparent card hoverable">
                            ...
                            <div class="macarte content-activity card-content">
                                <h5>Informez</h5>
                                <p>Offres promotionnelles, Informations légales, locales, Météo, … Humanisez l'attente avec des messages dynamiques et mise à jour simplement.</p>
                                <?php
                                if (strpos($_SERVER['HTTP_USER_AGENT'], 'Edg') !== FALSE) {
                                ?>
                    ...
                    <div class="col l3">
                        <div class="transparent card hoverable">
                            ...
                            <div class="macarte content-activity card-content">
                                <h5>Optimisez</h5>
                                <p>Fini le panneau liège. Transmettez l'information interne à vos équipes, indicateurs clés de performance, plans d'actions, résultats en temps réel.</p>
                                <?php
                                if (strpos($_SERVER['HTTP_USER_AGENT'], 'Edg') !== FALSE) {
                                ?>
        ...
        <div class="container">
            <div class="row">
                <div>
                    <a href="contact.php?id=Banque%20|%20Assurance" class="col l4 offset-l4 s12 button_contact">
